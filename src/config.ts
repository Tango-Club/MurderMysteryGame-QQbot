...
export class BotConfig {
    constructor(appID?: string, token?: string, sandbox?: boolean, shards?: Array<number>, intents?: Array<AvailableIntentsEventsEnum>, maxRetry?: number) {
        this.appID = appID ? appID : "appID";
        this.token = token ? token : "token";
        this.sandbox = sandbox ? sandbox : false;
        this.shards = shards;
        this.intents = intents ? intents : [AvailableIntentsEventsEnum.PUBLIC_GUILD_MESSAGES];
